...
resp = HTTP.get("https://www.quandl.com/api/v3/datasets/USTREASURY/YIELD.json?api_key=<KEY>")
...
resp = HTTP.get("https://www.quandl.com/api/v3/datasets/AAII/AAII_SENTIMENT.json?api_key=<KEY>")
str = String(resp.body)
job=JSON.parse(str)
...
resp = HTTP.get("https://www.quandl.com/api/v3/datasets/FRED/T10YIE.json?api_key=<KEY>")
str = String(resp.body)
job=JSON.parse(str)
...
resp = HTTP.get("https://www.quandl.com/api/v3/datasets/FRED/T5YIFR.json?api_key=<KEY>")
str = String(resp.body)
job=JSON.parse(str)
